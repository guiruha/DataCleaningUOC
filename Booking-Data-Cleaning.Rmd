...
booking_numeric <- booking %>%
  select(-c("city", "month_in", "check_in", "month_out", "check_out", "postal_code", "latitude", "longitude"))

sapply(booking_numeric, function(y) sum(is.na(y)))

# Creamos una matriz de correlación del dataset
cor_mat <- cor(booking_numeric)
