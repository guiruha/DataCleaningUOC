...
norm_cols <- c("value_for_money_score", "comfort_score", "hotel_score", "staff_score", "cleanliness_score", "location_score", "facilities_score")
...
ggplot(booking, aes(x = month, y = min_price, color = month)) + 
  geom_boxplot()
